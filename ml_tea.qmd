...
i\. **roi_p.gpkg**: This is the region of interest (roi) geopackage for the tea plantations in Embu, Kenya.

ii\. **s2_large.tif**: The is the Sentinel-2 image for the region of interest.

iii\. **vect.gpkg**: This is the polygons of tea and non-tea areas for model training.

iv\. **eval.gpkg**: This is observed 200 points consisting of 100 true tea and 100 non tea for testing the model performance.
